...
public class Main {
    ...
    public static int[] heroesHealth = {250, 260, 270,200};
    public static int[] heroesDamage = {20, 15, 10 };
    public static int[]AspirineMan ={25};

    public static String[] heroesAttackType = {"Физический",
            "Магический", "Кинетический","Лечение"};
    ...
    public static void printStatistics() {
        ...
        System.out.println("Излечил на "+ AspirineMan[0]);
